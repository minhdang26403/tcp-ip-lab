...

    {
      ...
      test.execute(ExpectFrame {
        make_frame(local_eth,
                   ...
                   EthernetHeader::TYPE_ARP,
                   serialize(make_arp(
                     ARPMessage::OPCODE_REPLY, local_eth, "5.5.5.5", remote_eth, "10.0.1.1")))});
      test.execute(ExpectNoFrame {});
    }
...

    {
      ...
      test.execute(ExpectFrame {
        make_frame(local_eth,
                   ...
                   EthernetHeader::TYPE_ARP,
                   serialize(make_arp(
                     ARPMessage::OPCODE_REPLY, local_eth, "10.0.0.1", remote_eth1, "10.0.0.5")))});
      test.execute(ExpectNoFrame {});
      ...
      test.execute(ReceiveFrame {
        make_frame(remote_eth2,
                   ...
                   EthernetHeader::TYPE_ARP,
                   serialize(make_arp(
                     ARPMessage::OPCODE_REQUEST, remote_eth2, "10.0.0.19", {}, "10.0.0.1"))),
        {}});
      test.execute(ExpectFrame {
        make_frame(local_eth,
                   remote_eth2,
                   EthernetHeader::TYPE_ARP,
                   serialize(make_arp(
                     ARPMessage::OPCODE_REPLY, local_eth, "10.0.0.1", remote_eth2, "10.0.0.19")))});
      test.execute(ExpectNoFrame {});
