...
add_custom_target (format "clang-format-17" -i ${ALL_SRC_FILES} COMMENT "Formatting source code...")
...
foreach (tidy_target ${ALL_SRC_FILES})
  ...
  set (tidy_command clang-tidy-17 --quiet -header-filter=.* -p=${PROJECT_BINARY_DIR} ${tidy_target})
